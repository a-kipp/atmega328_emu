...
uint16_t dec_extractBits0000000011111000(uint16_t instruction) {
    return (instruction & 0b0000000011111000) >> 3;
}

uint16_t dec_extractBits0000100000000000(uint16_t instruction) {
    return (instruction & 0b0000100000000000) >> 11;
}