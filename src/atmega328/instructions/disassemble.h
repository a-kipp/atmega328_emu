...
// AVR Instruction Manual page 32
InstructionInfo andi_disassemble(uint16_t opCode, uint16_t programCounter) {
    ...
    snprintf(instruction.info, INFO_LENGTH, "andi %s(%02X), %02X", _getName(rd_addr), rdContent, constData);
    instruction.length =  1;
